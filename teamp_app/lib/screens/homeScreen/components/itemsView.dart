                        ...
                        child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                fit: BoxFit.cover,
                                image: NetworkImage(productsNotifier.productsList[index].image)),
                            ),),
                      ),
                      Expanded(
                        child: Container(
...
class MarketPriceSellProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      child: Text("Sell Your Product", style: TextStyle(fontSize: getScreenWidth(16), color: Colors.white,)),
      ),
        ),
        SizedBox(height: getScreenHeight(5)),
      SizedBox(
        ...
        child: Text("Current Market Retail Prices", style: TextStyle(fontSize: getScreenWidth(16), color: Colors.white,)),
        ),
      ),
      ],
    );
